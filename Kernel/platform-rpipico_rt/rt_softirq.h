...
#define SIG_ID_TIMESTAMP_REQ 1
#define SIG_ID_RX 2
#define SIG_ID_TX 3
#define SIG_ID_TX_READY 4
#define SIG_ID_TRANSFER_FLASH_REQ 5
#define SIG_ID_TRIM_FLASH_REQ 6
#define SIG_ID_TRANSFER_SD_REQ 7
#define SIG_ID_TRIM_SD_REQ 8
#define SIG_ID_TRANSFER_DISK1_REQ 9
#define SIG_ID_TRIM_DISK1_REQ 10
#define SIG_ID_TRANSFER_DISK2_REQ 11
#define SIG_ID_TRIM_DISK2_REQ 12
#define SIG_ID_TRANSFER_DISK3_REQ 13
#define SIG_ID_TRIM_DISK3_REQ 14
