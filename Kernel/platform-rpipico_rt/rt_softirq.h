...
#define SIG_ID_TRANSFER_DISK1_REQ 4
#define SIG_ID_TRIM_DISK1_REQ 5
#define SIG_ID_TRANSFER_DISK2_REQ 6
#define SIG_ID_TRIM_DISK2_REQ 7
#define SIG_ID_TRANSFER_DISK3_REQ 8
#define SIG_ID_TRIM_DISK3_REQ 9
