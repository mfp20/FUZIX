// all options available with brief comments and some sort of categorization
// Note: it's a work in progress to make a porting helper file to keep in docs/
